...
var ajax_save_fields_list_url = '{$VH->site_url("admin/search/save/$group_id/")}';
...
$(document).ready(function(){ldelim}
        ...
        $("#save").click(function() {ldelim}
        		ajax_loader_show("{$LANG_SEARCH_SAVE_MSG}");
                     ...
                     <ul class="sortable" style="float: left;">
                       ...
                       <li id="field_{$field.id}" class="drag">
								...
								{if $field.search_configuration_page}
									<a href="{$VH->site_url("admin/fields/configure_search/$field_id/")}">{$LANG_CONFIGURE_FIELD_SEARCH}</a>
								{/if}
							</div>
                       </li>
                       {/foreach}
