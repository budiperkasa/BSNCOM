...
{assign var="field_id" value=$field->id}
                ...
                <div class="content">
                	{$VH->validation_errors()}
					 ...
					 <a href="{$VH->site_url("admin/fields/configure/$field_id/add_option/")}" title="{$LANG_ADD_CURRENCY}"><img src="{$public_path}/images/buttons/page_add.png" /></a>
                     <a href="{$VH->site_url("admin/fields/configure/$field_id/add_option/")}">{$LANG_ADD_CURRENCY}</a>&nbsp;&nbsp;&nbsp;&nbsp;
                     ...
                     <table id="drag_table" class="standardTable" border="0" cellpadding="2" cellspacing="2">
                        <tr class="nodrop nodrag">
                         ...
                         <th style="width: 300px;">{$LANG_CURRENCY_TH}</th>
