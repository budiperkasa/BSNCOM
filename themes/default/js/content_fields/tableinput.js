				$(document).ready( function() {
                    $("#add_option").click(function() {
                        ...
                        $('<tr id="' + option_id + '_id"><td>&nbsp;</td><td><input type="text" name="' + option_id + '_option" size="45"></td><td><input class="button delete_button delete_field_now" type=button name="delete" onClick="delete_checkbox_option_from_table(this)" value="Delete"></td></tr>').appendTo('.standardTable');
