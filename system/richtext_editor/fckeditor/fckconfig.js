...
// Uncomment this string to enable youtube plugin
...
FCKConfig.ToolbarSets["Review"] = [
	['RemoveFormat','-','Bold','Italic','Underline','StrikeThrough','-','TextColor','-','OrderedList','UnorderedList','-','Link','Unlink','-','Image','Smiley']
] ;
