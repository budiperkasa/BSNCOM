...
class CI_Validation {
	...
	var $_errors_block_prefix = '<div class="error_msgs"><div class="error_msg rounded_corners"><ul>';
	var $_errors_block_suffix = '</ul></div></div>';
	 ...
	 * @return	void
	 */	
	function set_error_delimiters($prefix = '<div class="error_msg">', $suffix = '</div>')
	{
	...
	function run()
	{
		...
		$this->error_string = $this->_errors_block_prefix;
		...
		$this->error_string .= $this->_errors_block_suffix;
