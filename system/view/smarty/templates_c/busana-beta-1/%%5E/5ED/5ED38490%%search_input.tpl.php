<?php /* Smarty version 2.6.26, created on 2012-02-06 08:03:48
         compiled from content_fields/search/checkboxes/search_input.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'content_fields/search/checkboxes/search_input.tpl', 49, false),)), $this); ?>
<script language="JavaScript" type="text/javascript">
jQuery( function($) {
	$("#any_<?php echo $this->_tpl_vars['field']->seo_name; ?>
").change( function() {
		checkAll_<?php echo $this->_tpl_vars['field']->seo_name; ?>
();
	});
...
();
	...
	function checkAll_<?php echo $this->_tpl_vars['field']->seo_name; ?>
() {
		if ($("#any_<?php echo $this->_tpl_vars['field']->seo_name; ?>
").is(":checked")) {
			$(".<?php echo $this->_tpl_vars['field_index']; ?>
...
>
								...
								<div>
	                     			<span><?php echo $this->_tpl_vars['LANG_MATCH']; ?>
:</span><br />
	                     			<label style="display:block;"><input type="radio" name="<?php echo $this->_tpl_vars['field_mode']; ?>
" value="any" <?php if ($this->_tpl_vars['args'][$this->_tpl_vars['field_mode']] == 'any' || ! $this->_tpl_vars['args'][$this->_tpl_vars['field_mode']]): ?>checked<?php endif; ?> /> <?php echo $this->_tpl_vars['LANG_ANY_MATCH']; ?>
</label>
	                     			<label style="display:block;"><input type="radio" name="<?php echo $this->_tpl_vars['field_mode']; ?>
" value="exact" <?php if ($this->_tpl_vars['args'][$this->_tpl_vars['field_mode']] == 'exact'): ?>checked<?php endif; ?> /> <?php echo $this->_tpl_vars['LANG_EXACT_MATCH']; ?>
</label>
                     			</div>
                     		</div>