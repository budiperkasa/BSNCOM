<?php /* Smarty version 2.6.26, created on 2012-03-05 07:05:57
         compiled from frontend/listings/listing_full.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'frontend/listings/listing_full.tpl', 33, false),array('modifier', 'count', 'frontend/listings/listing_full.tpl', 34, false),array('modifier', 'nl2br', 'frontend/listings/listing_full.tpl', 86, false),)), $this); ?>
...
/images/buttons/page_link.png" /></a>&nbsp;
												...
												<?php if ($this->_tpl_vars['listing']->type->locations_enabled && $this->_tpl_vars['listing']->locations_count(true) && $this->_tpl_vars['listing']->level->maps_enabled): ?>
													<a href="<?php echo $this->_tpl_vars['VH']->site_url("listings/".($this->_tpl_vars['listing_unique_id'])); ?>
#addresses" id="open_iw_<?php echo $this->_tpl_vars['listing_unique_id']; ?>
...
?>
												<div class="address_line"><?php if ($this->_tpl_vars['location']->calcDistanceFromCenter()): ?><span class="address_label" style="color: #006699"><?php echo $this->_tpl_vars['location']->calcDistanceFromCenter(); ?>
</span>&nbsp;&nbsp;<?php endif; ?> <?php if ($this->_tpl_vars['listing']->locations_count() > 1): ?><span class="address_label"><?php echo $this->_tpl_vars['LANG_LISTING_ADDRESS']; ?>
...
:</span> <?php endif; ?><?php echo $this->_tpl_vars['location']->compileAddress(); ?>
	                         			...
	                         			<div class="clear_float"></div>
	                         			<?php echo $this->_tpl_vars['listing']->outputMode('full'); ?>

	                         			<a href="<?php echo $this->_tpl_vars['VH']->site_url("listings/".($this->_tpl_vars['listing_unique_id'])); ?>
" class="view_listing_link"><?php echo $this->_tpl_vars['LANG_VIEW_LISTING']; ?>
 >>></a>
	                         		</div>