<?php /* Smarty version 2.6.26, created on 2012-03-05 06:52:17
...
images/icons/chart_organisation.png"></a> <a class="search_category"><?php echo $this->_tpl_vars['LANG_SEARCH_CATEGORIES']; ?>
			                ...
			                <?php endif; ?>
                     		...
                     		<div class="search_filter_standart">
                     			<div>
                     				<a href="javascript: void(0);" id="what_match"><img style="padding-top: 8px;" src="<?php echo $this->_tpl_vars['public_path']; ?>
...
" />
                     		...
                     		<div class="search_filter_advanced">
	                     		<div id="advanced_search_button">
	                     			<a href="<?php echo $this->_tpl_vars['VH']->site_url("search/"); ?>
"><?php echo $this->_tpl_vars['LANG_FULL_DIRECTORY']; ?>
</a>
	                     		</div>
	                     	</div>
	                     	<?php endif; ?>
