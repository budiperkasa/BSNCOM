<?php /* Smarty version 2.6.26, created on 2012-02-06 03:14:04
         compiled from files_upload/site_logo_upload_block.tpl */ ?>
...
: <?php echo $this->_tpl_vars['VH']->str_replace('|',', ',$this->_tpl_vars['allowed_types']); ?>
						...
						<div id="img_wrapper">
							<div id="img_div_border" style="<?php if (! isset ( $this->_tpl_vars['current_file'] )): ?>display:none; <?php endif; ?>width: <?php echo $this->_tpl_vars['attrs']['width']; ?>
...
px">
										<tr>
											<td valign="middle" align="center">
												<img id="img" src="<?php if (isset ( $this->_tpl_vars['current_file'] )): ?><?php echo $this->_tpl_vars['upload_to']; ?>
...
" value="<?php if (isset ( $this->_tpl_vars['current_file'] )): ?><?php echo $this->_tpl_vars['current_file']; ?>
<?php endif; ?>">
								</div>
							</div>
