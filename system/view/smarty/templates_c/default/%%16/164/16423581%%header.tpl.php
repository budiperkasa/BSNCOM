...
smarty_core_load_plugins(array('plugins' => array(array('function', 'addslashes', 'frontend/header.tpl', 38, false),array('modifier', 'count', 'frontend/header.tpl', 75, false),)), $this); ?>
...
" />
		...
		<!-- I18n panels Starts -->
			<div id="header_right">
				...
				<?php endif; ?>
				<?php echo $this->_tpl_vars['VH']->buildContentPagesMenu_top($this->_tpl_vars['CI']); ?>
...
" class="<?php if ($this->_tpl_vars['type']->id == $this->_tpl_vars['current_type']->id): ?>active_type<?php endif; ?>"><?php echo $this->_tpl_vars['type']->name; ?>
</a></li>
					<?php if (count($this->_tpl_vars['types']) != ( $this->_tpl_vars['i']++ ) + 1): ?>
						<li>|</li>
					<?php endif; ?>
				<?php endforeach; endif; unset($_from); ?>
			</ul>
