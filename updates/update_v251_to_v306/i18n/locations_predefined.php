...
$language['LANG_LOCATIONS_LIST_DESCR'] = "Labeled locations highlighted with bold. When location labeled - it appears in 'Search in ...' block at the frontend";
...
$language['LANG_IS_UNIQUE_LOCATION_SEONAME'] = "The location with this seo name is already existed!";
$language['LANG_PREDEFINED_LOCATIONS_MODE'] = "Predefined locations mode";
$language['LANG_PREDEFINED_LOCATIONS_MODE_DISABLED'] = "predefined locations disabled (users may enter any location)";
$language['LANG_PREDEFINED_LOCATIONS_MODE_ONLY'] = "use only predefined locations (users will be able to choose locations from list)";
...
// Navigation block
$language['LANG_LOCATIONS_SEARCH_IN'] = "Search in";
$language['LANG_LOCATIONS_EVERYWHERE'] = "everywhere";
...
$language['LANG_LABELED_LOCATIONS_SUCCESS'] = "Locations items were labeled successfully!";
?>